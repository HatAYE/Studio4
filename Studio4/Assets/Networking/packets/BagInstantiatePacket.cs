...
public class BagInstantiatePacket : BasePacket
{
    ...
    public BagInstantiatePacket(PlayerData player, List<int> prefabIndex, List<string> objectIDs, string GameObjectID) :
        base(player, PackType.indexInstantiate, GameObjectID)
    {
    ...
    public new BagInstantiatePacket Deserialize(byte[] buffer)
    {
        ...
        objectIDs = new List<string>(IDListCount);
